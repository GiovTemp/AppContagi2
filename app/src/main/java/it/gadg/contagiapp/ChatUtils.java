...
public class ChatUtils {
    ...
    private final String APP_NAME = "ContagiAPP";
    ...
    public synchronized void setState(int state) {
        this.state = state;
        handler.obtainMessage(BtActivity.MESSAGE_STATE_CHANGED, state, -1).sendToTarget();
    }
    ...
    private synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message message = handler.obtainMessage(BtActivity.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
